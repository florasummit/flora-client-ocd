...
5. **Shared and nonexclusive programs.** OCD may participate in shared or multi-brand promotional programs only as permitted by the operative agreement. Such participation does not waive or terminate Flora Summit’s OCD-specific exclusive rights.
6. **Successors and changes in control.** The parties intend the exclusive rights and related protections to apply to covered OCD successors, permitted assigns, transfers, controlled entities, replacement operators, and anti-circumvention arrangements to the maximum extent permitted by law.
7. **Cure protection.** A claimed material breach by Flora Summit requires written notice and at least 120 days to cure, or longer while Flora Summit is diligently curing a matter that reasonably cannot be completed within 120 days, except where applicable law requires otherwise.
8. **Regulatory separation.** Flora Summit does not receive ownership, control, management authority, or a financial interest in an OMMA-licensed business merely through the marketing and sweepstakes relationship. All regulated cannabis operations remain the responsibility of the properly licensed operator.
